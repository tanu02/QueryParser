 ...
 * */
public class InstacartRedShiftDB {

    private static final String JDBC_URL = "jdbc:redshift://redshift-cluster-1.cpup7ovbrmnr.us-east-2.redshift.amazonaws.com:5439/instacart";
    ...
    public InstacartRedShiftDB() throws SQLException {
