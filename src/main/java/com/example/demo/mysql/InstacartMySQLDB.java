...
public class InstacartMySQLDB {
    private Connection connect;

    String myUrl = "jdbc:mysql://aws-dbds-database.cvlkkwfb5kw8.us-east-2.rds.amazonaws.com:3306/instacart_normalized";

    String username = "admin";

    String pass = "1234567890";

    public InstacartMySQLDB() throws SQLException {
